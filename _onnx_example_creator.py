...
# ref = https://leimao.github.io/blog/ONNX-Python-API/
...
def create(output_opset_general_version):
    ...
    conv1_W_initializer_tensor = _create_initializer_tensor(
        name=conv1_W_initializer_tensor_name,
        tensor_array=conv1_W,
        data_type=onnx.TensorProto.FLOAT)
    conv1_B_initializer_tensor_name = "Conv1_B"
    conv1_B_initializer_tensor = _create_initializer_tensor(
    ...
    bn1_scale_initializer_tensor = _create_initializer_tensor(
        name=bn1_scale_initializer_tensor_name,
        tensor_array=bn1_scale,
        data_type=onnx.TensorProto.FLOAT)
    bn1_bias_initializer_tensor = _create_initializer_tensor(
        name=bn1_bias_initializer_tensor_name,
        tensor_array=bn1_bias,
        data_type=onnx.TensorProto.FLOAT)
    bn1_mean_initializer_tensor = _create_initializer_tensor(
        name=bn1_mean_initializer_tensor_name,
        tensor_array=bn1_mean,
        data_type=onnx.TensorProto.FLOAT)
    bn1_var_initializer_tensor = _create_initializer_tensor(
    ...
    model_def = onnx.helper.make_model(graph_def, producer_name="onnx-cli")
    model_def.opset_import[0].version = output_opset_general_version
